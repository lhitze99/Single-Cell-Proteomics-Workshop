...
![](images/clipboard-3136407371.png)
...
# (you already saw the function that you need to use here)
...
Why divide by reference channels? Reference channel is less noisy than a single cell, so dividing them by a single cell could scale them to a common control and correct for run-to-run bias, technical variability, and improve the comparability across samples.
...
```{r}
## Get the features related to PUR9 
