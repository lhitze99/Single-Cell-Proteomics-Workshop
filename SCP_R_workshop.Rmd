...
PIF ranges between 0 and 1.
A high PIF (close to 1) means the isolation is clean 
A low PIF (< 0.5) means contamination by co-isolated ions and can lead to noisy or mixed MS/MS spectra

@Lara: How about we change the PIF>0.3 and have a question here: 
